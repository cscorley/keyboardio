...
KEYMAPS(
  ...
  (___,          Key_1,    Key_2,    Key_3,    Key_4,    Key_5,    Key_LEDEffectNext,
   ...
   Key_PrintScreen, Key_6,    Key_7,    Key_8,     Key_9,      Key_0,         ShiftToLayer(NUMPAD),
  ...
  (___,      Key_F1,            Key_F2,        Key_F3,          Key_F4,               Key_F5, Key_CapsLock,
   Key_Tab,  ___,               Key_mouseUp,   Key_LeftBracket, Key_LeftCurlyBracket, ___,    Key_mouseScrollUp,
   ...
   Consumer_PlaySlashPause,    Consumer_ScanNextTrack, Key_RightCurlyBracket,    Key_RightBracket,         Key_LeftBracket, Key_RightBracket, Key_F12,
